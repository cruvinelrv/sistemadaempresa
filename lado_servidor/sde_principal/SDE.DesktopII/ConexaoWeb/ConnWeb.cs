...
namespace SDE.Desktop.ConexaoWeb
{
    public class ConnWeb
    {
        ...
        public delegate void EventoEscreveArquivoTEF(string conteudo, string complemento);
		...
		public delegate void EventoEscreveArquivoNFExml(string conteudo, string chaveAcessoNFE);
        ...
        object proxy_ExternalInterfaceCall(object sender, ExternalInterfaceCallEventArgs e)
        {
            ...
            switch (comando)
            {
                ...
                case "web_chama_desktop_enviatef":
                    this.eventoEscreveArquivoTEF.Invoke(args[1].ToString(), args[2].ToString());
                    break;
				...
				case "web_chama_desktop_envianfe_xml":
                    this.eventoEscreveArquivoNFExml.Invoke(args[1].ToString(), args[2].ToString());
                    break;
