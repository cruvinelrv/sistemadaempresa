    ...
    class GerenteEtiquetas
    {
        ...
        public void enviaImpressao(int idCorp)
        {
            if (idCorp == 44 || idCorp == 53)
            {
                ...
                byte[] fileDataBat = request.DownloadData(Program.SDE_EMERGENCIA + "argox/" + idCorp + "/enviaImpressao.bat");
                ...
                request.Credentials = new NetworkCredential("Administrator", Program.SENHA_FTP);
                byte[] fileDataTxt = request.DownloadData(Program.SDE_EMERGENCIA + "argox/" + idCorp + "/confImpressao.txt");
            ...
            else if (idCorp == 56 || idCorp == 68 || idCorp == 20 || idCorp == 64 || idCorp == 76 || idCorp == 83 || idCorp == 70 || idCorp == 99)
            {
                ...
                request.Credentials = new NetworkCredential("Administrator", Program.SENHA_FTP);
                byte[] fileData = request.DownloadData(Program.SDE_EMERGENCIA + idCorp + "/etiqueta.pdf");
