	...
	private function usuario_escolheu_estoque_para_carrinho():void
	{
		...
		{
			Alert.show("Estoque não encontrado para o produto", "Mensagem SDE", 4, null, null, Imagens.unica.icn_32_deleta);
			return;
		}
	}
 	...
 	private function usuario_escolheu_item_para_carrinho():void
	{
		...
		{
			Alert.show("Estoque não encontrado para o produto. Consulte o suporte para maiores informações.", "Mensagem SDE", 4, null, null, Imagens.unica.icn_32_deleta);
			return;
		}
	}
	...
	private function usuario_lanca_item_para_carrinho():void
	{
		...
		{
			Alert.show("O Desconto Concedido ultrapassa o valor do Desconto Máximo para este ítem", "Mensagem SDE", 4, null, null, Imagens.unica.icn_32_alerta);
			return;
		}
		if (descDado != 0)	
	...
	private function lancarValorFinal():void
	{
		...
		if(nsDescFinal_valor.value == indicador_venda_valor_final)
		{
			...
			{
				descVlrFinal = true;
				Alert.show("O Valor Final da Venda não deve ser superior aa Valor Original da Venda!", "Mensagem SDE", 4, null, null, Imagens.unica.icn_32_deleta);
