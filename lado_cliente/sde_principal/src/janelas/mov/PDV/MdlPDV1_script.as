...
import flash.ui.Keyboard;
	...
	private function lancarAtual():void
	{
		...
		for each (var a:ItemEmpAliquotas in App.single.cache.arrayItemEmpAliquotas)
		{
			if (a.idItem==atualItem.id)
			{
				mi.icmsAliq = a.icmsAliq_SD;
				mi.icmsAliqPadrao = a.icmsAliqPadrao_SD;
			}
		}
