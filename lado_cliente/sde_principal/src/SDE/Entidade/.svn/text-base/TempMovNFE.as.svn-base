...
{
    [Bindable]
    [RemoteClass(alias='SDE.Entidade.TempMovNFE')]
    public final class TempMovNFE
    {
        public static function get CLASSE():String{return 'TempMovNFE';}
        ...
        public function TempMovNFE(obj:Object=null){if (obj==null)return;for each(var campo:String in getCampos())this[campo]=obj[campo];}        public function injeta(o:*):void{for each (var campo:String in TempMovNFE.getCampos()){this[campo]=o[campo];}}
        public function clone():TempMovNFE{return new TempMovNFE(this);}
        public function toString():String
        {
            return '[TempMovNFE '+id+']';
        }
