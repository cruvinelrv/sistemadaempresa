...
{
    [Bindable]
    [RemoteClass(alias='SDE.Entidade.ClienteFuncionarioComissionamento')]
    public final class ClienteFuncionarioComissionamento
    {
        public static function get CLASSE():String{return 'ClienteFuncionarioComissionamento';}
        public static function getCampos():Array{return['id','idEmp','idCliente','calculaMontanteTotal','calculaMaoDeObra','calculaMaoDeObraGeral','calculaMaoDeObraGarantia','calculaMaoDeObraGeralGarantia','calculaProdutosEmGarantia','calculaProdutos','comissaoMontanteTotal','comissaoMaoDeObra','comissaoMaoDeObraGeral','comissaoMaoDeObraGarantia','comissaoMaoDeObraGeralGarantia','comissaoProdutosEmGarantia','comissaoProdutos']};
        ...
        public function ClienteFuncionarioComissionamento(obj:Object=null){if (obj==null)return;for each(var campo:String in getCampos())this[campo]=obj[campo];}        public function injeta(o:*):void{for each (var campo:String in ClienteFuncionarioComissionamento.getCampos()){this[campo]=o[campo];}}
        public function clone():ClienteFuncionarioComissionamento{return new ClienteFuncionarioComissionamento(this);}
        public function toString():String
        {
            return '[ClienteFuncionarioComissionamento '+id+']';
        }
